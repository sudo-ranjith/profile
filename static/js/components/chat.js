...
function setUserResponse(message) {
    const user_response = `<img class="userAvatar" src="{{ url_for('static',filename='images/botAvatar.png') }}"><p class="userMsg">${message} </p><div class="clearfix"></div>`;
...
function setBotResponse(response) {
    ...
    setTimeout(() => {
        ...
        if (response.length < 1) {
            ...
            const BotResponse = `<img class="botAvatar" src="{{ url_for('static', filename='images/sara_avatar.png') }}"/><p class="botMsg">${fallbackMsg}</p><div class="clearfix"></div>`;
